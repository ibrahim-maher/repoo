...
def home(request):
    ...
    if request.method == "POST":
        ...
        if existing_user:
            ...
            # Use the existing user for registration
            user_for_registration = existing_user
        else:
            ...
            # Assign the new user for creating the registration
            user_for_registration = new_user
